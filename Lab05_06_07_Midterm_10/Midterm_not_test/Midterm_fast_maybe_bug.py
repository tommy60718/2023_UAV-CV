...
def dw(zi,rvec,tvec,drone,yaw_multi=0.5,x_multi=1):
    ...
    drone.send_rc_control(int(x_update*x_multi), int(z_update/2), int(y_update), int(yaw_update*yaw_multi))
...
while True:
    ...
    if markerCorners != []:
        ...
        if s1 and id==1:
            ...
            z4=125
            dw(z4,rvec[i],tvec,drone,0.5,0.9)
